...
def hr_dashboard():
    ...
    # LOAD DATA
    # ======================
    df = pd.read_csv(r"D:\Data\Dibimbing\streamlit_arucadia\Dataset\hr_final.csv")
    seg = pd.read_csv(r"D:\Data\Dibimbing\streamlit_arucadia\Dataset\hr_segment.csv")
    ...
    # ======================
    # KPI – READY FOR PROMOTION (DAX EQUIVALENT)
    # ======================
    total_emp = len(df_f)
